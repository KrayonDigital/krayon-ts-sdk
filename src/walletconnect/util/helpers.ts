import { COSMOS_MAINNET_CHAINS, TCosmosChain } from 'sdk/walletconnect/data/COSMOSData';
import { EIP155_CHAINS, TEIP155Chain } from 'sdk/walletconnect/data/EIP155Data';
import { NEAR_TEST_CHAINS, TNearChain } from 'sdk/walletconnect/data/NEARData';
import { SOLANA_CHAINS, TSolanaChain } from 'sdk/walletconnect/data/SolanaData';
import { ELROND_CHAINS, TElrondChain } from 'sdk/walletconnect/data/ElrondData';
import { TRON_CHAINS, TTronChain } from 'sdk/walletconnect/data/TronData';
...
export function getWalletAddressFromParams(addresses: readonly string[], params: any) {
  // TODO: improve this function, doesn't seem particularly robust
