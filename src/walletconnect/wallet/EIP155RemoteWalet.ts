...
import KrayonRemoteWallet, { KrayonRemoteWalletInitParams } from 'sdk/walletconnect/wallet/KrayonRemoteWallet';
...
import { ApproveRequestResult, WalletInfo } from 'sdk/types/walletconnect';
import { getChainId } from '../util/chain-utils';
import { KrayonWalletConnectSDK } from '../walletconnect-sdk';
import Krayon from 'shared/sdk/instance';
...
export default class EIP155RemoteWalet extends KrayonRemoteWallet {
  ...
  constructor(walletInfo: WalletInfo, params?: KrayonRemoteWalletInitParams) {
    ...
    this.krayonWalletConnectSdk = krayonWalletConnectSdk ?? Krayon.walletConnect;
