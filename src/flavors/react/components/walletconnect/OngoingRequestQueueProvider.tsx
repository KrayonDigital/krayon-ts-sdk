...
import { Election, ElectionDecision, ElectionResult } from 'sdk/types/election';
import { ApproveRequestResult } from 'sdk/types/walletconnect';
...
interface ElectionQueueInterface {
