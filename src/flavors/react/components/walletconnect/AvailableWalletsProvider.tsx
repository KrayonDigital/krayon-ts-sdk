...
import { WalletsResponse } from 'sdk/types/wallet';
import KrayonRemoteWallet from 'sdk/walletconnect/wallet/KrayonRemoteWallet';
import EIP155RemoteWalet from 'sdk/walletconnect/wallet/EIP155RemoteWalet';
import { ChainType } from 'sdk/walletconnect/data/ChainType';
import { EIP155_CHAINS } from 'sdk/walletconnect/data/EIP155Data';
      ...
      try {
        ...
        const walletMap = {
          'eip155': walletDtos
                      ...
                      .map((walletDto) => new EIP155RemoteWalet(walletDto)),
        }
