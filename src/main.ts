...
import { AuthPlugin, AuthPluginOptions } from 'sdk/types/plugins/auth';
import { KrayonTradeSDK } from './trade/trade-sdk';
import { KrayonAPIClient } from './api-client';
import { SDKReadyStatus } from './consts/enums';
import { KrayonWalletConnectSDK } from './walletconnect/walletconnect-sdk';
...
export class KrayonSDK {
  ...
  walletConnect: KrayonWalletConnectSDK;
