...
import { Election, ElectionErrorResponse, ElectionResult } from 'sdk/types/election';
import { DataWrap, KrayonAPICommonOptions } from 'sdk/types/common';
import { ElectionFilter, ElectionDetail, ElectionDecision, ElectionVote } from 'sdk/types/election';
